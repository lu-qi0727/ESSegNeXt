...
checkpoint_file = r'E:\lq\mmsegmentation-5channel\my_model\mscan_t_20230227-119e8c9f.pth'
...
data_preprocessor = dict(
    ...
    mean=[123.675, 116.28, 103.53, 103.53, 103.53],
    std=[58.395, 57.12, 57.375, 57.375, 57.375],
    bgr_to_rgb=True,
    pad_val=0,
    seg_pad_val=255,
    size=(512, 512),
...
# Step 3: Assign modified weights back to the model
...
param_scheduler = [
    dict(
        type='LinearLR', start_factor=1e-6, by_epoch=False, begin=50, end=1000),
    dict(
        type='PolyLR',
        power=1.0,
        begin=1000,
